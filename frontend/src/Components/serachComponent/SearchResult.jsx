...
const SearchResult = ({results, forcastResults}) => {
  ...
  return (
    <div className='bg-slate-300 min-h-full rounded-md md:text-sm shadow-md shadow-slate-400'>
      <div className="row pl-2">
        <div className="col-5 flex  flex-col justify-center items-start">
      ...
      <div className="row mt-2 bg-white">
        <div className="forecastData  w-full">
            <div className="coming-days md:flex flex-col pl-0 pr-2 py-1 bg-slate-200">

                  {/* 3 day forcast */}
                    {isShow3DayForcast && (
                      <div className="3-dayForcast col-12 md:max-h-[176px] md:min-h-[176px] flex flex-col items-start justify-start overflow-y-scroll">
